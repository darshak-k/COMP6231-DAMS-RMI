...
public class MTLHospitalServer extends UnicastRemoteObject implements HospitalServerInterface {
	...
	public MTLHospitalServer() throws RemoteException {
		super();
		addTestData();
	}
	...
	public String montrealListAppointmenOfType(AppointmentType appointmentType) {
		StringBuilder response = new StringBuilder();
		if (database.containsKey(appointmentType)) {
			HashMap<String, AppointmentDetails> data = database.get(appointmentType);
	...
	public String montrealBookAppointment(String patientID, String appointmentID, AppointmentType appointmentType) {
		StringBuilder response = new StringBuilder();
